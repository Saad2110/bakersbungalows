...
class VikCronJob
{
	...
	public static function getAdminParameters()
	{
		...
		$def_html_txt .= '<p><br></p>' . "\n";
		$def_html_txt .= '<p>Attached to this message you will find the invoice for your booking.</p>' . "\n";
		$def_html_txt .= '<p><br></p>' . "\n";
		$def_html_txt .= '<p><br></p>' . "\n";
		...
		return array(
			'cron_lbl' => array(
				'type' => 'custom',
				'label' => '',
				'html' => '<h4><i class="vboicn-file-text2"></i><i class="vboicn-coin-dollar"></i>Invoices Generator</h4>'
			),
			'checktype' => array(
				'type' => 'select',
			...
			'skipotas' => array(
				'type' => 'select',
				'label' => JText::_('VBOCRONINVGENPARAMSKIPOTAS').'//'.JText::_('VBOCRONINVGENPARAMSKIPOTASHELP'),
				'options' => array(
					 'ON'  => JText::_('VBYES'),
					 'OFF' => JText::_('VBNO'),
				)
			...
			'test' => array(
				'type' => 'select',
				'label' => JText::_('VBOCRONINVGENPARAMTEST').'//'.JText::_('VBOCRONINVGENPARAMTESTHELP'),
